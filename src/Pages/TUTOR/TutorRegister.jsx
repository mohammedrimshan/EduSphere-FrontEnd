  ...
  const handleVerify = async (otp) => {
    try {
      ...
      if (verifyResponse.data.message === "OTP verified successfully") {
        const registerResponse = await axiosInterceptor.post(`/tutor/signup`, {
        ...
        if (registerResponse.data.message === "Tutor registered successfully") {
    ...
    try {
      ...
      if (response.data && response.data.tutor) {
        const tutorData = {
          ...
          bio:response.data.tutor.bio || null,
          image:response.data.tutor.profile_image || null
        };
