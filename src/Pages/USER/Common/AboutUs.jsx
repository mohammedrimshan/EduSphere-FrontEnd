      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto scrollbar-hide">
          ...
          <section className="relative h-[500px] overflow-hidden">
            ...
            >
              <source
                src="https://res.cloudinary.com/dbair2ulh/video/upload/v1734719719/uqdqd6vaxhyoheicncv4.mp4"
                type="video/mp4"
              />
            </video>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  technology with expert instruction to create an engaging
                  learning experience that helps students achieve their goals
