...
import { FaUsers, FaBook, FaChalkboardTeacher, FaStar as FaStar2, FaGraduationCap, FaClock, FaEnvelope } from "react-icons/fa";
          ...
          <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                <img
                  src={tutor.profile_image || "/placeholder.svg?height=200&width=200"}
                  alt={tutor.full_name}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-400 mb-2">{tutor.subject}</p>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-center">
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      ...
                      <div className="text-2xl font-bold text-green-500">{tutor.totalStudents}</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">Students</div>
                    </div>
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <FaChalkboardTeacher className="text-3xl text-blue-500 mx-auto mb-2" />
                      <div className="text-2xl font-bold text-blue-500">{tutor.totalCourses}</div>
            ...
            {/* Courses Section */}
            <h2 className="text-2xl font-bold mb-6">Courses by {tutor.full_name}</h2>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="text-green-500 font-bold">
                        ₹{calculateDiscountedPrice(course.price, course.offer_percentage)}
